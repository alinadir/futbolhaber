...
from home.models import SosyalMedia


# Create your views here.

def besiktas(request):#ana sayfamızın
	haberler = SosyalMedia.objects.filter(haberin_konusu="Beşiktaş")[:5]
